...
const ProctorAegisHomepage = () => {
  ...
  const stats = [
    { label: "Concurrent Users", value: "100+", icon: <Users className="h-5 w-5" /> },
    { label: "Code Languages", value: "5+", icon: <Code className="h-5 w-5" /> },
    ...
    <div className={`min-h-screen transition-all duration-700 ease-in-out ${
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          <h1 className="text-5xl md:text-7xl lg:text-9xl font-black mb-10 bg-gradient-to-r from-black via-gray-700 to-black dark:from-white dark:via-gray-200 dark:to-white bg-clip-text text-transparent animate-fade-in-up tracking-tight pb-10">
            ProctorAegis
          </h1>
      ...
      <section id="tech" className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center items-center gap-6 mb-16">
            {['FastAPI', 'PostgreSQL', 'React', 'Judge0', 'Docker'].map((tech, index) => (
              <Badge 
                key={index} 
                variant="outline" 
